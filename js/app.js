class ParticleSystem {
    ...
    createParticles() {
        ...
        for (let i = 0; i < this.particleCount; i++) {
            ...
            particle.style.cssText = `width:${size}px;height:${size}px;left:${Math.random() * window.innerWidth}px;top:${Math.random() * window.innerHeight}px;--tx:${(Math.random() - .5) * 400}px;--ty:${(Math.random() - .5) * 400}px;animation-duration:${Math.random() * 20 + 20}s;animation-delay:${Math.random() * 5}s;`;
